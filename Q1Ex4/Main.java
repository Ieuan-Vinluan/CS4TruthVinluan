public class Main {
    public static void main(String[] args) {
        ...
        // 2 instances of Song
        Song songOne = new Song("...Baby One More Time", "Britney Spears", "B.spears", 10000000, 1998);
        Song songTwo = new Song("All I Want for Christmas Is You", "Mariah Carey", "songs you hear in the mall in september", 16000000, 1994);
        ...
        singerOne.setFavoriteSong(new Song("Lover", "Taylor Swift", "flop", 3200000, 2019)); // change favorite song
    }
}
